...
- **Dollar cost and the cost-meter sidebar** — Tier-2 (PLAN Phase 8). This is capture.
  *(Reinstated by T11 (#12) — see the amendment at the end of this file.)*
...
## Amendment (ticket T11, issue #12): the cost meter is reinstated, and it costs nothing to build
